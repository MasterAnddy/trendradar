...
def build_runtime_config(mode: str, timezone: str) -> dict[str, Any]:
    ...
    # The runtime config is written to RUNNER_TEMP, where timeline.yaml is not
    # present. ScheduleManager builds the selected preset before checking the
    # enabled flag, so retaining the base "morning_evening" preset raises even
    # though cloud scheduling is intentionally disabled.
